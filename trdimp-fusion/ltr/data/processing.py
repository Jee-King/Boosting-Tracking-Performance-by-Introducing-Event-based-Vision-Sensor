    ...
    def __call__(self, data: TensorDict):
        ...
        if self.transform['joint'] is not None:
            ...
            for i in range(len(test_event_copy)):
                test_event_copy[i], _ = self.transform['joint'](image=test_event_copy[i], bbox=data['test_anno'],
                                                                new_roll=False)
        ...
        for s in ['train', 'test']:
            ...
            for i in range(len(data[s + '_events'])):
                crops_event_tem, _ = prutils.target_image_crop(data[s + '_events'][i], jittered_anno, data[s + '_anno'],
