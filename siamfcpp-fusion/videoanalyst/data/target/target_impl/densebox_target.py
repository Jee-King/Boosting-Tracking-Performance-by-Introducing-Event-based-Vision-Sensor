...
class DenseboxTarget(TargetBase):
    ...
    def __call__(self, sampled_data: Dict) -> Dict:
        ...
        em_z1, em_z2, em_z3 = data_z["event1"],data_z["event2"],data_z["event3"]
        
        data_x = sampled_data["data2"]
        im_x, bbox_x = data_x["image"], data_x["anno"]
        em_x1, em_x2, em_x3 = data_x["event1"],data_x["event2"],data_x["event3"]
        ...
        em_z1, em_z2, em_z3 = em_z1.transpose(2, 0, 1), em_z2.transpose(2, 0, 1), em_z3.transpose(2, 0, 1)
        em_x1, em_x2, em_x3 = em_x1.transpose(2, 0, 1), em_x2.transpose(2, 0, 1), em_x3.transpose(2, 0, 1)
        # training target
