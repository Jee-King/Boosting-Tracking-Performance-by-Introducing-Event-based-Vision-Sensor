...
class ATOMnet(nn.Module):
    ...
    def forward(self, train_imgs, test_imgs, train_event_stack, test_event_stack, train_bb, test_proposals, ):
        ...
        train_event_feat1, train_event_feat2 = self.motion_attention_train(train_event_stack[0].transpose(0,1),
                                                                           train_event_stack[1].transpose(0,1),
                                                                           train_event_stack[2].transpose(0,1))
        test_event_feat1, test_event_feat2 = self.motion_attention_test(test_event_stack[0].transpose(0,1),
                                                                        test_event_stack[1].transpose(0,1),
                                                                        test_event_stack[2].transpose(0,1))
