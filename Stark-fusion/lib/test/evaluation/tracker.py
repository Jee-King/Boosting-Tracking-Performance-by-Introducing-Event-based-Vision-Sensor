...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, dataset_name: str, run_id: int = None, netname: str = None, display_name: str = None,
                 result_only=False):
    ...
    def run_sequence(self, seq, debug=None):
        ...
        """
        params = self.get_parameters(self.netname)
    ...
    def get_parameters(self,netepoch):
        ...
        params = param_module.parameters(self.parameter_name, netepoch)
        return params
