...
class Tracker:
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        # event_image = [np.zeros((260,346,3),dtype='uint8').fill(127),np.zeros((260,346,3),dtype='uint8').fill(127),\
        #                np.zeros((260,346,3),dtype='uint8').fill(127)]
        ...
        for frame_num, frame_path in enumerate(seq.frames[1:], start=1):
            ...
            # event_img = [np.zeros((260, 346, 3), dtype='uint8').fill(127), np.zeros((260, 346, 3), dtype='uint8').fill(127), \
            #                np.zeros((260, 346, 3), dtype='uint8').fill(127)]
