...
class RandomCropTransformer(TransformerBase):
    ...
    def __call__(self, sampled_data: Dict) -> Dict:
        ...
        im_temp, em_temp1,em_temp2,em_temp3, bbox_temp = data1["image"], data1['event1'], data1['event2'], data1['event3'], data1["anno"]
        im_curr, em_curr1,em_curr2,em_curr3, bbox_curr = data2["image"], data2['event1'], data2['event2'], data2['event3'], data2["anno"]
        im_z, em_z1,em_z2,em_z3,bbox_z, im_x,em_x1,em_x2,em_x3, bbox_x, _, _ = crop_track_pair(
        ...
        sampled_data["data1"] = dict(image=im_z, event1=em_z1,event2=em_z2,event3=em_z3, anno=bbox_z)
        sampled_data["data2"] = dict(image=im_x, event1=em_x1,event2=em_x2,event3=em_x3,anno=bbox_x)
