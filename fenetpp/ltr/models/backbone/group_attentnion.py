...
class Motion_Attention(nn.Module):
    def __init__(self):
        ...
        # self.ga1 = Group_Attention()
        # self.ga2 = Group_Attention()
        # self.ga3 = Group_Attention()
        # self.avg_pool = nn.AdaptiveAvgPool2d(1)
        ...
        # self.fw1_1.data.fill_(1.35)
        # self.fw1_2.data.fill_(1.47)
        # self.fw1_3.data.fill_(2.4)
        #
        # self.fw2_1.data.fill_(1.56)
        # self.fw2_2.data.fill_(1.60)
        # self.fw2_3.data.fill_(1.29)
    ...
    def forward(self, x1, x2, x3):
        ...
        # print('A:', self.fw1_1,self.fw1_2,self.fw1_3)
        # print('b:', self.fw2_1, self.fw2_2, self.fw2_3)
