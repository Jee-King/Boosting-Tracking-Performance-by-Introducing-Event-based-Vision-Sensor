...
def crop_track_pair(
        im_temp,em_temp1,em_temp2,em_temp3,
        bbox_temp,
        im_curr,em_curr1,em_curr2,em_curr3,
        bbox_curr,
        config=None,
        avg_chans=None,
        rng=np.random,
    ...
    if avg_chans is None:
        ...
        avg_chans_e1 = np.mean(em_temp1,axis=(0, 1))
        avg_chans_e2 = np.mean(em_temp2,axis=(0, 1))
        avg_chans_e3 = np.mean(em_temp3,axis=(0, 1))
    ...
    if mask_tmp is not None:
        ...
        im_z = get_subwindow_tracking(im_temp,
                                      ...
                                      s_temp,
                                      avg_chans=avg_chans)
        em_z1 = get_subwindow_tracking(em_temp1,
                                      box_crop_temp[:2],
                                      z_size,
                                      s_temp,
                                      avg_chans=avg_chans_e1)
        em_z2 = get_subwindow_tracking(em_temp2,
                                      box_crop_temp[:2],
                                      z_size,
                                      s_temp,
                                      avg_chans=avg_chans_e2)                                                             
        em_z3 = get_subwindow_tracking(em_temp3,
                                      box_crop_temp[:2],
                                      z_size,
                                      s_temp,
                                      avg_chans=avg_chans_e3)
    if mask_curr is not None:
        ...
        im_x = get_subwindow_tracking(im_curr,
                                      ...
                                      s_curr,
                                      avg_chans=avg_chans)
        em_x1 = get_subwindow_tracking(em_curr1,
                                      box_crop_curr[:2],
                                      x_size,
                                      s_curr,
                                      avg_chans=avg_chans_e1)
        em_x2 = get_subwindow_tracking(em_curr2,
                                      box_crop_curr[:2],
                                      x_size,
                                      s_curr,
                                      avg_chans=avg_chans_e2)    
        em_x3 = get_subwindow_tracking(em_curr3,
                                      box_crop_curr[:2],
                                      x_size,
                                      s_curr,
                                      avg_chans=avg_chans_e3)
        return im_z,em_z1,em_z2,em_z3, bbox_z, im_x, em_x1, em_x2, em_x3, bbox_x, mask_z, mask_x
