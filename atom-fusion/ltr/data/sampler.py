...
class KYSSampler(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Get frames
        train_frames, train_anno_dict, _ , train_event_frames = dataset.get_frames(seq_id, train_frame_ids, seq_info_dict)
        train_anno = train_anno_dict['bbox']

        test_frames, test_anno_dict, _ , test_event_frames = dataset.get_frames(seq_id, test_frame_ids, seq_info_dict)
