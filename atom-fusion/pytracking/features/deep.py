...
class ATOMResNet18(MultiFeatureBase):
    ...
    def extract(self, im: torch.Tensor, event_im):
        ...
        with torch.no_grad():
            ...
            output_event_features0, output_event_features1 = self.net.motion_attention_test(event_im[0], event_im[1], event_im[2])
            tmp1, tmp2 =  self.net.counter_guide_test(output_features[self.feature_layers[0]], output_features[self.feature_layers[1]],\
