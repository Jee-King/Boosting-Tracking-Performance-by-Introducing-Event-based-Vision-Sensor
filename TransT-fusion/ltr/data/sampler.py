...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        template_frames, template_anno, meta_obj_template, template_events = dataset.get_frames(seq_id, template_frame_ids, seq_info_dict)
        search_frames, search_anno, meta_obj_search, search_events = dataset.get_frames(seq_id, search_frame_ids, seq_info_dict)
