...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        train_frames, train_anno, meta_obj_train, train_events = dataset.get_frames(seq_id, train_frame_ids, seq_info_dict)
        test_frames, test_anno, meta_obj_test, test_events = dataset.get_frames(seq_id, test_frame_ids, seq_info_dict)
